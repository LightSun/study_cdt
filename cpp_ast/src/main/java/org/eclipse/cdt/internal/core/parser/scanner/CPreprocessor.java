...
public class CPreprocessor implements ILexerLog, IScanner, IAdaptable {
	...
	final private IIncludeFileTester<InternalFileContent> createCodeReaderTester
			= new IIncludeFileTester<InternalFileContent>() {
		@Override
	...
	final private IIncludeFileTester<IncludeResolution> createPathTester
			= new IIncludeFileTester<IncludeResolution>() {
		@Override
