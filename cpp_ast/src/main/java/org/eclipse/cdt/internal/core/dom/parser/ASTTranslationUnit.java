...
public abstract class ASTTranslationUnit extends ASTNode implements IASTTranslationUnit, ISkippedIndexedFilesListener {
	...
	// Caches
	private final ThreadLocal<WeakHashMap<IType, String>> fUnnormalizedTypeStringCache
			= new ThreadLocal<WeakHashMap<IType, String>>() {
		@Override
		protected WeakHashMap<IType, String> initialValue() {
			return new WeakHashMap<>();
		}
	};
	private final ThreadLocal<WeakHashMap<IType, String>> fNormalizedTypeStringCache
			= new ThreadLocal<WeakHashMap<IType, String>>() {
		@Override
		protected WeakHashMap<IType, String> initialValue() {
			return new WeakHashMap<>();
